...
5. Go back to step 1 and repeat until all features are finished. Break the loop if three delegated workers fail in a row (you can learn if a task was a success or failure by the subagent's output or by inspecting SPEC.md and git log).
</workflow>
